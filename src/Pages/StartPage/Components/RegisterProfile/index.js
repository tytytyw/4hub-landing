      ...
      {pageOption === "register" && (
        <div className={styles.main}>
          ...
          <div
            ...
            <div className={styles.buttonsGroup}>{renderRegTypes()}</div>

            {info.regType === "Бизнес версия" ? (
            ...
            <div className={styles.agreementWrap}>
              ...
              <div className={styles.agreementsText}>
                ...
                <span>{__("Политику конфиденциальности")}</span>
                {__("и")}
                <span>{__("Политику интелектуальной собственности")}</span>
              </div>
            </div>
            <div className={styles.button} onClick={() => sendRequest()}>
              {__("Создать аккаунт")}
            </div>
            <span className={styles.orSpan}>{__("или")}</span>
            <div className={styles.socialNetworks}>
              <div className={styles.linkedIn}>
                <img src="./assets/StartPage/linkedIn.svg" alt="lIn" />
              </div>
              <div className={styles.facebook}>
                <img src="./assets/StartPage/fb.svg" alt="fb" />
              </div>
              <div className={styles.twitter}>
                <img src="./assets/StartPage/twitter.svg" alt="twit" />
              </div>
              <div className={styles.google}>
                <img src="./assets/StartPage/google.svg" alt="goog" />
              </div>
              <div className={styles.pinterest}>
                <img src="./assets/StartPage/pinterest.svg" alt="p" />
              </div>
              <div className={styles.vk}>
                <img src="./assets/StartPage/vk.svg" alt="vk" />
              </div>
            </div>
