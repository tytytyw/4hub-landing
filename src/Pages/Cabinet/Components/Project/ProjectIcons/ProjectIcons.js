  ...
  const renderIcons = () => {
    const getIcon = (icon) => {
      switch (icon) {
        ...
        case "coworking":
          return <CoworkingIcon className={color.name} alt="icon" />;
        case "lamp":
          return <LampIcon className={color.name} alt="icon" />;
        case "pen":
          return <PenIcon className={color.name} alt="icon" />;
        case "rocket":
          return <RocketIcon className={color.name} alt="icon" />;
        case "suitcase":
          return <SuitcaseIcon className={color.name} alt="icon" />;
        case "thunder":
          return <ThunderIcon className={color.name} alt="icon" />;
        default:
          return <ClipboardIcon className={color.name} alt="icon" />;
      }
    };
