...
import Intro from '../StartPage/Components/Intro';
import UploadFile from '../StartPage/Components/UploadFile';
import Infopage from '../StartPage/Components/InfoPage';
import DownloadFile from '../StartPage/Components/DownloadFile';
import EnterProfile from '../StartPage/Components/EnterProfile';
import RegisterProfile from '../StartPage/Components/RegisterProfile';
import ForgotPassword from '../StartPage/Components/ForgotPassword';
import RenewPassword from '../StartPage/Components/RenewPassword';
import Landing from './Components/Landing/Landing'
import DownloadFolder from "../StartPage/Components/DownloadFolder";

const StartPage = ({setOptions}) => {

    const [pageOption, setPage] = useState('landing');
