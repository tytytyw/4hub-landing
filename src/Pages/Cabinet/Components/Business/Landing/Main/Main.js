...
function Main({ scrollTop }) {
  ...
  const scrollHandler = (e) => {
    ...
    if (
      ...
      (Math.abs(e.deltaY) < 100
        ? e.layerY !== layerYOld || document.body.style.overflow === "visible" || deltaYOld !== Math.sign(e.deltaY)
        : true)
    ) {
  ...
  useEffect(() => {
    ...
    document.querySelector(`.${styles.presentation_wrap}`).style.transform = `translateY(${count * -100}%)`;
  ...
  if (sliderWrap) sliderWrapStyles.height = window.innerHeight - sliderWrap.offsetTop;
    ...
    <div>
      ...
      >
        <div className={styles.presentation_wrap}>
          <section className={styles.slide}>
            <div id="slide-text_1" className={classNames(styles.text_item, styles.text_item_active)}>
              <h4 className={styles.presentation__title}>{__("Файлообменник")}</h4>
              <p className={styles.presentation__text}>{__("Cистематизация данных в одном пространстве")}</p>
              <p className={styles.presentation__text}>{__("Предоставление доступа к загруженным файлам")}</p>
              <p className={styles.presentation__text}>{__("Разграничение прав доступа к файлам")}</p>
            </div>

            <div id="slide-picture_1" className={classNames(styles.image_wrap)}>
              <img
                className={classNames(styles.presentation__image, styles.image_1_1)}
                src={imageSrc + "assets/BusinessCabinet/slider_item_1_1.png"}
                alt={__("добавление файла")}
              />
              <img
                className={classNames(styles.presentation__image, styles.image_1_2)}
                src={imageSrc + "assets/BusinessCabinet/slider_item_1_2.png"}
                alt={__("добавление файла")}
              />
              <img
                className={classNames(styles.presentation__image, styles.image_1_3)}
          ...
          <section className={styles.slide}>
            <div id="slide-text_2" className={styles.text_item}>
              <h4 className={styles.presentation__title}>{__("Оптимизация командной работы")}</h4>
              <p className={styles.presentation__text}>{__("Возможность организации конференций")}</p>
              ...
              <p className={styles.presentation__text}>{__("Приватная работа с документами")}</p>
            </div>

            <div id="slide-picture_2" className={styles.image_wrap}>
              <img
                className={classNames(styles.presentation__image, styles.image_2_1)}
                src={imageSrc + "assets/BusinessCabinet/slider_item_2_1.png"}
                alt={__("совместный проект")}
              />
              <img
                className={classNames(styles.presentation__image, styles.image_2_2)}
          ...
          <section className={styles.slide}>
            <div id="slide-text_3" className={styles.text_item}>
              <h4 className={styles.presentation__title}>{__("Конфиденциальность и безопасность")}</h4>
              <p className={styles.presentation__text}>{__("Надежная защита личных и корпоративных данных")}</p>
              <p className={styles.presentation__text}>{__("Шифрование файлов")}</p>
            </div>

            <div id="slide-picture_3" className={styles.image_wrap}>
              <img
                className={classNames(styles.presentation__image, styles.image_3_1)}
                src={imageSrc + "assets/BusinessCabinet/slider_item_3_1.png"}
                alt={__("добавление файла")}
              />
              <img
                className={classNames(styles.presentation__image, styles.image_3_2)}
                src={imageSrc + "assets/BusinessCabinet/slider_item_3_2.png"}
                alt={__("добавление файла")}
              />
              <img
                className={classNames(styles.presentation__image, styles.image_3_3)}
          ...
          <section className={styles.slide}>
            <div id="slide-text_4" className={styles.text_item}>
              <h4 className={styles.presentation__title}>{__("Интеграция необходимых сервисов")}</h4>
              <p className={styles.presentation__text}>{__("Синхронизация со сторонними сервисами")}</p>
              <p className={styles.presentation__text}>{__("Встроенный магазин программного обеспечения")}</p>
            </div>

            <div id="slide-picture_4" className={styles.image_wrap}>
              <img
                className={classNames(styles.presentation__image, styles.image_4)}
                src={imageSrc + "assets/BusinessCabinet/slider_item_4.png"}
                alt={__("синхронизация")}
              />
              <img
                className={classNames(styles.presentation__image, styles.image_4_youtube)}
                src={imageSrc + "assets/StartPage/youtube.svg"}
                alt={__("youtube")}
              />
              <img
                className={classNames(styles.presentation__image, styles.image_4_telegram)}
                src={imageSrc + "assets/StartPage/telegram.svg"}
                alt={__("telegram")}
              />
              <img
                className={classNames(styles.presentation__image, styles.image_4_google_calendar)}
                src={imageSrc + "assets/StartPage/google_calendar.svg"}
                alt={__("google calendar")}
              />
              <img
                className={classNames(styles.presentation__image, styles.image_4_google_drive)}
                src={imageSrc + "assets/StartPage/google_drive.svg"}
                alt={__("google drive")}
              />
              <img
                className={classNames(styles.presentation__image, styles.image_4_figma)}
                src={imageSrc + "assets/StartPage/figma.svg"}
                alt={__("figma")}
              />
              <img
                className={classNames(styles.presentation__image, styles.image_4_viber)}
                src={imageSrc + "assets/StartPage/viber.svg"}
                alt={__("viber")}
              />
              <img
                className={classNames(styles.presentation__image, styles.image_4_whatsapp)}
                src={imageSrc + "assets/StartPage/whatsapp.svg"}
                alt={__("whatsapp")}
              />
              <img
                className={classNames(styles.presentation__image, styles.image_4_skype)}
      ...
      <section className={styles.storage}>
        ...
        <div className={styles.tariffs_list}>
          ...
          <Tariff name={"Premium"} cost={100} discont={50} currentPlan={false} promo={__("Предложение дня")} />
          <Tariff name={__("Premium plus")} cost={120} currentPlan={false} promo={""} />
        </div>
      </section>
    </div>
  );
