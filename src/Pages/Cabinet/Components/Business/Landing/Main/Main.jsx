					...
					<section className={styles.slide}>
						...
						<div id="slide-picture_1" className={classNames(styles.image_wrap)}>
							<img
								...
								src="./assets/BusinessCabinet/slider_item_1_1.png"
							...
							<img
								...
								src="./assets/BusinessCabinet/slider_item_1_2.png"
								alt="добавление файла"
							/>
							<img
								className={classNames(
								...
								src="./assets/BusinessCabinet/slider_item_1_3.png"
								alt="добавление файла"
							/>
						</div>
					</section>
					<section className={styles.slide}>
						...
						<div id="slide-picture_2" className={styles.image_wrap}>
							<img
								...
								src="./assets/BusinessCabinet/slider_item_2_1.png"
							...
							<img
								...
								src="./assets/BusinessCabinet/slider_item_2_2.png"
								alt="совместный проект"
							/>
						</div>
					</section>
					<section className={styles.slide}>
						...
						<div id="slide-picture_3" className={styles.image_wrap}>
							<img
								...
								src="./assets/BusinessCabinet/slider_item_3_1.png"
								alt="добавление файла"
							/>
							<img
								className={classNames(
								...
								src="./assets/BusinessCabinet/slider_item_3_2.png"
								alt="добавление файла"
							/>
							<img
								className={classNames(
								...
								src="./assets/BusinessCabinet/slider_item_3_3.png"
								alt="добавление файла"
							/>
						</div>
					</section>
					<section className={styles.slide}>
						...
						<div id="slide-picture_4" className={styles.image_wrap}>
							<img
								...
								src="./assets/BusinessCabinet/slider_item_4.png"
								alt="синхронизация"
							/>
							<img
								className={classNames(
