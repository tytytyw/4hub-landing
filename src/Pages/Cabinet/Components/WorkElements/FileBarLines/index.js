          ...
          <div className={styles.file_info}>
            ...
            <div className={styles.descr}>
              ...
              <div className={styles.symbols}>
                <div>
                  {file?.is_pass ? <img src={`${imageSrc}assets/PrivateCabinet/locked.svg`} alt="lock" /> : null}
                </div>
                <div>
                  {file?.fig ? <img src={`${imageSrc}assets/PrivateCabinet/signs/${file.fig}.svg`} alt="fig" /> : null}
                </div>
                <div>
                  {file?.emo ? (
