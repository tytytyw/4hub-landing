...
function TextDraw({canvas, onFinishDraw, addTool}) {
    ...
    const [params, setParams] = useState({text: 'Text', move: false, widthDif: 0, heightDif: 0, sizeChange: false, positionX: '50%', positionY: '50%'});
    ...
    const drawText = async (canvas, textBlockRef) => {
        ...
        canvasTxt.drawText(
            ...
            textBlockRef.current.clientWidth - 4, textBlockRef.current.clientHeight - 4
        )
    }
