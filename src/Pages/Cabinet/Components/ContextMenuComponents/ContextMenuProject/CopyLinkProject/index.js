                ...
                <main>
                    <div className={styles.sendAccessWrap}>
                        ...
                        <div className={`${styles.project}`}>
                            <FolderIcon className={`${styles.projectIcon} ${colors.filter(el => el.color === project.info.color)[0]?.name}`} />
                            <div className={styles.projectInfo}>{project.info.name}</div>
                        </div>
                        <div className={styles.buttonsWrap}>
                            <div className={styles.cancel} onClick={() => setSendAccess(false)}>Отмена</div>
                            <div className={styles.send} onClick={sendProject}>Отправить</div>
                        </div>
                    </div>
                </main>
            </div> : null}
...
export default CopyLinkProject
