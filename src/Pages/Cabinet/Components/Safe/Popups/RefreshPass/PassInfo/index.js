...
const PassInfo = ({setVisible, value, inputRef, setEnable}) => {
    ...
    const [data, setData] = useState([
        ...
        {id: 2, label: __('Содержит как строчные (a-z), так и прописные буквы (A-Z)'), checked: false},
        {id: 3, label: __('Содержит по крайней мере одну цифру (0-9) или символ'), checked: false},
        {id: 4, label: __('Не содержит ваше имя или адрес электронной почты'), checked: false},
        {id: 5, label: __('Не часто используется или предыдущий пароль'), info: true},
    ])
    ...
    useEffect(() => {
        ...
        setData([
            {id: 1, label: __('Cодержит не менее 8 симв.'), checked: value?.length >= 8},
            {id: 2, label: __('Содержит как строчные (a-z), так и прописные буквы (A-Z)'), checked: hasUpperLowerCase(value)},
            {id: 3, label: __('Содержит по крайней мере одну цифру (0-9) или символ'), checked: hasNumOrChar(value)},
            {id: 4, label: __('Не содержит ваше имя или адрес электронной почты'), checked: false},
            {id: 5, label: __('Не часто используется или предыдущий пароль'), info: true},
        ])
