...
export const messengersData = [
  {
    label: "Email",
    type: "email",
    icon: `${imageSrc}assets/PrivateCabinet/email.svg`,
  },
  {
    label: "SMS",
    type: "tel",
  ...
  },
  {
    ...
    link: `viber://forward?text=${registerLink}`,
  },
  {
    label: "WhatsApp",
    type: "whatsapp",
    icon: `${imageSrc}assets/PrivateCabinet/socials/whatsapp.svg`,
    link: `https://api.whatsapp.com/send/?text=${registerLink}`,
  },
  {
    label: "Telegram",
    type: "telegram",
    icon: `${imageSrc}assets/PrivateCabinet/socials/telegram.svg`,
    link: `https://t.me/share/url?url=${registerLink}`,
  },
];
