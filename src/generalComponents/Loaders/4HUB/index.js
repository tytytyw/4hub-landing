  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`${styles.yellowSquareFirst} ${styles[type + "First"]}`}
        />
        <div
          className={`${styles.yellowSquareSecond} ${styles[type + "Second"]}`}
        />
        <div
          className={`${styles.yellowSquareThird} ${styles[type + "Third"]}`}
        />
      </div>
    </div>
  );
