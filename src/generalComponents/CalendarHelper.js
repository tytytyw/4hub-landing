...
export function useMonths() {
    const { __ } = useLocales();
    return (year) => [
        {id: 0, name: __('Январь'), declensionName: __('Января'), code: 1, days: 31},
        {id: 1, name: __('Февраль'), declensionName: __('Февраля'), code: 4, days: year % 4 === 0 ? 29 : 28},
        {id: 2, name: __('Март'), declensionName: __('Марта'), code: 4, days: 31},
        {id: 3, name: __('Апрель'), declensionName: __('Апреля'), code: 0, days: 30},
        ...
        {id: 7, name: __('Август'), declensionName: __('Августа'), code: 3, days: 31},
        {id: 8, name: __('Сентябрь'), declensionName: __('Сентября'), code: 6, days: 30},
        {id: 9, name: __('Октябрь'), declensionName: __('Октября'), code: 1, days: 31},
        {id: 10, name: __('Ноябрь'), declensionName: __('Ноября'), code: 4, days: 30},
        {id: 11, name: __('Декабрь'), declensionName: __('Декабря'), code: 6, days: 31}
    ];
}
